...
namespace ConsumersTest.ConsumerServiceReference {
    ...
    public interface IConsumerService {
        ...
        ConsumersTest.ConsumerServiceReference.Consumer[] GetAll();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsumerService/GetAll", ReplyAction="http://tempuri.org/IConsumerService/GetAllResponse")]
        System.Threading.Tasks.Task<ConsumersTest.ConsumerServiceReference.Consumer[]> GetAllAsync();
        ...
        ConsumersTest.ConsumerServiceReference.Consumer Get(int consumerId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsumerService/Get", ReplyAction="http://tempuri.org/IConsumerService/GetResponse")]
        System.Threading.Tasks.Task<ConsumersTest.ConsumerServiceReference.Consumer> GetAsync(int consumerId);
        ...
        void Add(ConsumersTest.ConsumerServiceReference.Consumer consumer);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsumerService/Add", ReplyAction="http://tempuri.org/IConsumerService/AddResponse")]
        System.Threading.Tasks.Task AddAsync(ConsumersTest.ConsumerServiceReference.Consumer consumer);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsumerServiceChannel : ConsumersTest.ConsumerServiceReference.IConsumerService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsumerServiceClient : System.ServiceModel.ClientBase<ConsumersTest.ConsumerServiceReference.IConsumerService>, ConsumersTest.ConsumerServiceReference.IConsumerService {
        ...
        public ConsumersTest.ConsumerServiceReference.Consumer[] GetAll() {
            return base.Channel.GetAll();
        }
        
        public System.Threading.Tasks.Task<ConsumersTest.ConsumerServiceReference.Consumer[]> GetAllAsync() {
            return base.Channel.GetAllAsync();
        }
        
        public ConsumersTest.ConsumerServiceReference.Consumer Get(int consumerId) {
            return base.Channel.Get(consumerId);
        }
        
        public System.Threading.Tasks.Task<ConsumersTest.ConsumerServiceReference.Consumer> GetAsync(int consumerId) {
        ...
        public void Add(ConsumersTest.ConsumerServiceReference.Consumer consumer) {
            base.Channel.Add(consumer);
        }
        
        public System.Threading.Tasks.Task AddAsync(ConsumersTest.ConsumerServiceReference.Consumer consumer) {
